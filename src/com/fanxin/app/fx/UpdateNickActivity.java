...
public class UpdateNickActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final String nick = LocalUserInfo.getInstance(UpdateNickActivity.this)
				.getUserInfo("nick");
	...
	private void updateIvnServer(final String newNick) {
		...
		String hxid = LocalUserInfo.getInstance(UpdateNickActivity.this)
				.getUserInfo("hxid");
		map.put("newNick", newNick);
		map.put("hxid", hxid);
		final ProgressDialog dialog = new ProgressDialog(
				UpdateNickActivity.this);
		...
		registerTask.getData(new DataCallBack() {
			...
			public void onDataCallBack(JSONObject data) {
				...
				try {
					...
					if (code == 1) {
						LocalUserInfo.getInstance(UpdateNickActivity.this)
								.setUserInfo("nick", newNick);
						finish();

					} else {

						Toast.makeText(UpdateNickActivity.this, "更新失败...",
