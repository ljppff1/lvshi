...
public class FragmentFriends extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (((MainActivity) getActivity()).unreadAddressLable.getVisibility() == View.VISIBLE) {
			...
			tv_unread.setText(((MainActivity) getActivity()).unreadAddressLable
					.getText());
		...
		RelativeLayout re_newfriends = (RelativeLayout) headView
				.findViewById(R.id.re_newfriends);
		RelativeLayout re_chatroom = (RelativeLayout) headView
				.findViewById(R.id.re_chatroom);
