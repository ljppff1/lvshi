...
public class LasterLoginUserActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		list = DemoApplication.getInstance().list;
		...
		autoListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (view.getTag() == "HEADER" || view.getTag().equals("HEADER")
						|| view.getTag() == "FOOTER"
						|| view.getTag().equals("FOOTER")) {
					return;
				}
				...
				intent.setClass(LasterLoginUserActivity.this,
	...
	public List<JSONObject> getData() {
		...
		System.out.println("上传的数据是------->>>>>>>>" + String.valueOf(page));
