...
public class LvShiShouYeAdapter extends SBaseAdapter {
   ...
   private Context context;
	...
	protected void newView(View convertView) {
		...
		holder.mFFF =(com.rvidda.cn.view.FlowLayout)convertView.findViewById(R.id.mFFF);
	...
	protected void holderView(View convertView, Object itemObject, int position) {
		...
		FlowLayout mFFF = (com.rvidda.cn.view.FlowLayout)convertView.findViewById(R.id.mFFF);
	...
	Drawable drawable1=context.getResources().getDrawable(R.drawable.flag_01); 
