...
/**
 * 
 * http请求返回响应回调函数基类 Used to intercept and handle the responses from requests
 * made using {@link AsyncHttpClient}. The {@link #onSuccess(String)} method is
...
public class AsyncHttpResponseHandler {
	...
	protected void handleMessage(Message msg) {
		...
		case FAILURE_MESSAGE:
			response = (Object[]) msg.obj;
			Throwable dd = (Throwable) response[0];
			String dd1 = response[1].toString();
			handleFailureMessage(dd,dd1);
			break;
		case START_MESSAGE:
			onStart();
			break;
