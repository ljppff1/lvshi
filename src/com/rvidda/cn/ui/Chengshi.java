...
public class Chengshi extends BaseActivity{
    ...
    private void initView() {
		 ...
		 mGv1.setOnItemClickListener(new OnItemClickListener() {
			...
			expandableGridView = (com.rvidda.cn.view.MyExpandableListView)this.findViewById(R.id.list);
...
public View getChildView(int groupPosition, int childPosition,
	...
	gridview = (com.rvidda.cn.view.MyGridView) convertView.findViewById(R.id.gridview);
...
*/}
	...
	class  Myadapter extends   BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			Holder holder = null;
			if(convertView==null){
				convertView = LayoutInflater.from(Chengshi.this)
