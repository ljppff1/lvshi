...
public class GeRenZiLiao extends BaseActivity{
	...
	private void initView() {
		...
		mListView =(com.rvidda.cn.view.MyListView)this.findViewById(R.id.mListView);
		...
		mListView.setAdapter(adapter);
		 ...
		 mFFF = (com.rvidda.cn.view.FlowLayout)this.findViewById(R.id.mFFF);
			for(int i=0;i<10;i++){
		        ...
		        layoutParamsButtonCancel.leftMargin = dip2px(getApplicationContext(), 1);  
		        layoutParamsButtonCancel.rightMargin = dip2px(getApplicationContext(), 1);  
		        layoutParamsButtonCancel.topMargin= dip2px(getApplicationContext(), 1);  
		        layoutParamsButtonCancel.bottomMargin= dip2px(getApplicationContext(), 1);  
	...
	class  Myadapter extends   BaseAdapter{
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			Holder holder = null;
			if(convertView==null){
				convertView = LayoutInflater.from(GeRenZiLiao.this)
						.inflate(R.layout.item_pingjia_layout, null);
				holder = new Holder();
