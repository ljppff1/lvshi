...
import com.rvidda.cn.ui.Zixun.Holder;
import com.rvidda.cn.ui.Zixun.Myadapter;
...
public class ShouYe extends BaseActivity{
    ...
    private String[] listd1 ={"婚姻","交通","税务","债务","合同","房屋","劳动协议","知识产权","其它","婚姻","更多"};
			  ...
			  toast.show();
				...
				handler.postDelayed(new Runnable() {
                  ...
                  flagl =false;
						...
						flagl=true;	
							  Toast toast = Toast.makeText(getApplicationContext(), "录音时间太短", 0);
							  toast.setGravity(Gravity.CENTER, 0, 0);
							  toast.show();
						}
					}
		...
		mVVli.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				case MotionEvent.ACTION_UP:
					  ...
					  y2 = event.getY();
					  if(y1 - y2 > 50) {
							  startActivity(new Intent(getApplicationContext(), ZiXunLieBiao.class));
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			holder.mRlg1.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if(item.getFlag()){
						mTvg1.setTextColor(getApplicationContext().getResources().getColor(R.color.black));
						mIvg1.setImageResource(R.drawable.biaoqiandise);
					item.setFlag(false);
					}else{
						item.setFlag(true);
						mTvg1.setTextColor(getApplicationContext().getResources().getColor(R.color.white));
	...
	OnClickListener listener =new OnClickListener() {
		...
		case R.id.mIvtalk:
			...
			break;
		case R.id.mRlsure:
			startActivity(new Intent(getApplicationContext(), TiChuZiXun.class));
			break;
		default:
			break;
		}
